...
//var datos1=[0,0,500,0,500,250,0,0],datos2=[0,0,500,0,500,250,500,500,0,500,500,250,500,0,0,0],datos3=[0,0,500,250,0,500,0,0],i=2;
svg.append("polygon")
.attr({
	points:datos1,
	fill:"url(#imgpattern)",
...
{
	if(i==3)
		svg.selectAll("image").attr({"xlink:href":"assets/images/negrow.png"});
